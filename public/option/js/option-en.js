...
function queryEntrust (msg) {
  ...
  if (CONTENTS.length == 0) {
    ...
    $('#alert').addClass('hide');
    ReactDOM.render(React.createElement(EntrustContentsOptions, { contents: pbUtils.sortDlEn(CONTENTS, '159') }), document.getElementById('contents'));
  }
}
...
//var con56 = '', con160 = '', con52 = '', con54 = '', con162 = '', con63 = '', con44 = '', con161 = '';
var cancelPar = {
      '65': '',
      '160': '',
      '52': '',
