...
function queryEntrust(msg, dataTime) {
  ...
  if (CONTENTS1.length == 0) {
    ...
    ReactDOM.render(React.createElement(EntrustContentsHistory, { contents: CONTENTS, history: true }), document.getElementById('contents'));
  }
}
...
$(function () {
  ...
  var option = {
    callbacks: [{fun: 6052, module: 90002, callback: function (msg) {queryEntrust(msg, dataTime);}}
               ],
