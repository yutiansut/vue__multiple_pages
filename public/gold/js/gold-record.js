      ...
      var obj = {
        wtGeneralRequest:function () {
          var data = {
                ...
                ReactDOM.render(React.createElement(RecContents, { contents: data.jData.data }), document.getElementById('contents'));
        },
...
function queryRecord(msg) {
  ...
  if (msg.functionNO == 6205) {
    if (msg.jData['1'] < 0) {
      ...
      ReactDOM.render(React.createElement(RecContents, { contents: CONTENTS }), document.getElementById('contents'));
    }
  }
}
