...
function queryDeal(msg, dataTime) {
  ...
  if (CONTENTS1.length == 0) {
    ...
    ReactDOM.render(React.createElement(DealContentsHis, { contents: CONTENTS, history: true }), document.getElementById('contents'));
  }
}
...
$(function () {
  ...
  ReactDOM.render(React.createElement(TimeTitle, { times: TIMES, deal: true }), document.getElementById('time-title'));
  ReactDOM.render(React.createElement(DealTitleHis, null), document.getElementById('title'));
